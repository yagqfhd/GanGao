(function () {
    ...
    app.controller("usersDetail", ['$scope', "language", "usersService", "rolesService", "$routeParams", "utils", "$modal", function ($scope, language, usersService, rolesService, $routeParams, utils, $modal) {
