...
(function () {
    ...
    lang["base"] = {
        ...
        emptyName: "名称不能为空",
        saveSuccess: "保存信息成功",
        formNotModified: "表单没有任何需要保存修改项目",
        confirmDelete: "是否需要删除当前项目",
        deleteSuccess: "删除成功！"
    };
    lang["userList"] = {
    ...
    lang["rolesList"] = {
        ...
        name: "角色",
        Perm: "权限",
        notAllowEmpty: "角色名称不允许为空！",
        confirmDelete: "确定删除当前角色吗？",
        deleteSuccess: "删除当前角色成功！"
    };
    lang["roleChoose"] = {
        title: "选择权限",
        choosePerms: "选择权限",
